...
export default function StatusPagePage() {
  ...
  const { statusPage, components, monitors, canUpdate, isLoading, isRestoring, error } =
  ...
  // Show loading state during hydration, cache restoration, or when no data exists
