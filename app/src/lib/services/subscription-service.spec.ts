...
const mockDbQueryOrgFindFirst = db.query.organization.findFirst as jest.Mock;
const mockDbQueryPlanLimitsFindFirst = db.query.planLimits
...
describe("SubscriptionService", () => {
  ...
  beforeEach(() => {
    ...
    mockDbQueryOrgFindFirst.mockResolvedValue(mockOrganization);
    ...
    describe("getOrganizationPlan", () => {
      describe("Positive Cases", () => {
        it("should return plus plan limits for plus subscription", async () => {
          ...
          expect(mockDbQueryOrgFindFirst).toHaveBeenCalled();
        });
        ...
        it("should return pro plan limits for pro subscription", async () => {
          const proPlanLimits = {
            ...mockPlanLimits,
            plan: "pro" as const,
            playwrightMinutesIncluded: 5000,
          };
          mockDbQueryOrgFindFirst.mockResolvedValue({
            ...mockOrganization,
            subscriptionPlan: "pro",
          });
          mockDbQueryPlanLimitsFindFirst.mockResolvedValue(proPlanLimits);
      ...
      describe("Security Cases", () => {
        ...
        it("should reject invalid plan names in cloud mode", async () => {
          mockDbQueryOrgFindFirst.mockResolvedValue({
            ...mockOrganization,
            subscriptionPlan: "enterprise" as "plus", // Invalid plan, cast to test runtime validation
          });
        ...
        it("should reject free plan in cloud mode", async () => {
          mockDbQueryOrgFindFirst.mockResolvedValue({
            ...mockOrganization,
            subscriptionPlan: "free" as "plus", // Invalid plan, cast to test runtime validation
          });
    ...
    describe("getPlanLimits", () => {
      describe("Positive Cases", () => {
        it("should return plan limits from database", async () => {
          ...
          expect(result.plan).toBe("plus");
          expect(mockDbQueryPlanLimitsFindFirst).toHaveBeenCalled();
        });
