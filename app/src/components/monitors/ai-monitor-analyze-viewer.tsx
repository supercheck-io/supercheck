...
interface AIMonitorAnalyzeViewerProps {
    open: boolean;
    onClose: () => void;
    content: string;
    isStreaming: boolean;
...
export function AIMonitorAnalyzeViewer({
    ...
    const handleDownload = () => {
        try {
            ...
            a.href = url;
            a.download = `monitor-analysis-${monitorId.substring(0, 8)}.md`;
    ...
    // Format monitor type for display
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <DialogDescription className="text-xs">
                                {monitorName} • {formatMonitorType(monitorType)}
                            </DialogDescription>
                        </div>
                    </div>
