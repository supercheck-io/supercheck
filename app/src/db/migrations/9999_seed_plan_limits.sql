...
-- AI Credits: 100 credits/month (for AI fix and AI create features)
...
SELECT
  gen_random_uuid(), 'plus', 25, 1, 3000, 20000, 100, 5, 50, 5, 2, 10, 3,
...
-- AI Credits: 300 credits/month (for AI fix and AI create features)
INSERT INTO "plan_limits" (
  "id", "plan", "max_monitors", "min_check_interval_minutes",
  "playwright_minutes_included", "k6_vu_minutes_included", "ai_credits_included",
  "running_capacity", "queued_capacity", "max_team_members",
...
SELECT
  gen_random_uuid(), 'pro', 100, 1, 10000, 75000, 300, 10, 100, 25, 10, 50, 15,
...
-- All limits set to 999999 for unlimited usage
INSERT INTO "plan_limits" (
  "id", "plan", "max_monitors", "min_check_interval_minutes",
  "playwright_minutes_included", "k6_vu_minutes_included", "ai_credits_included",
  "running_capacity", "queued_capacity", "max_team_members",
...
SELECT
  gen_random_uuid(), 'unlimited', 999999, 1, 999999, 999999, 999999, 999, 9999, 999, 999, 999, 999,
...
-- Playwright: $0.03/minute (Plus) and $0.02/minute (Pro)
-- K6: $0.01/VU-minute for both plans
-- AI Credits: $0.05/credit (Plus) and $0.03/credit (Pro)
INSERT INTO "overage_pricing" (
  "id", "plan", "playwright_minute_price_cents", "k6_vu_minute_price_cents", "ai_credit_price_cents",
  "created_at", "updated_at"
)
SELECT
  gen_random_uuid(), 'plus', 3, 1, 5, NOW(), NOW()
...
SELECT
  gen_random_uuid(), 'pro', 2, 1, 3, NOW(), NOW()
