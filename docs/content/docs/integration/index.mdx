...
Connect Supercheck with your development workflow, CI/CD pipelines, and external tools for seamless automation.

<Callout type="info">
  Use Supercheck's API to trigger tests remotely, integrate with CI/CD, and build custom workflows.
</Callout>

## Overview

Supercheck provides multiple integration options:

- **API Integration**: Trigger tests programmatically with REST API
- **CI/CD Integration**: Run tests in your deployment pipeline
- **Webhooks**: Receive real-time notifications about test results
