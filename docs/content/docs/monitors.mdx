...
- **Action Buttons** — Quick access to Pause, Edit, and Delete operations
- **Demo Badge** — Indicates if this is a demo monitor (demo monitors are read-only)
...
| Metric | Description |
|--------|-------------|
| **Status** | Current monitor status (Up, Down, Degraded, Paused) |
