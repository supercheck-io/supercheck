...
<Cards>
<Card title="Playground" href="/docs/automate/playground">
Learn more about AI Create, AI Fix, and the test editor
</Card>

<Card title="Monitors" href="/docs/monitors">
Set up comprehensive uptime monitoring
</Card>

<Card title="Variables" href="/docs/automate/variables">
Store API keys and secrets securely
</Card>

<Card title="Status Pages" href="/docs/communicate/status-pages">
