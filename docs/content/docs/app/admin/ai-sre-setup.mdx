...
```mermaid
flowchart TD
    Services["<b>1. Add Services</b><br/>Define systems & telemetry"] --> Links["<b>2. Link Checks</b><br/>Monitors · jobs · tests"]
    ...
    Recipes --> Verify["<b>5. Test Investigation</b><br/>Run a test investigation"]

    style Services fill:#eef2ff,stroke:#4338ca,color:#3730a3
    style Links fill:#eff6ff,stroke:#1e40af,color:#1e40af
    style Connectors fill:#f5f3ff,stroke:#6d28d9,color:#5b21b6
    style Recipes fill:#fffbeb,stroke:#b45309,color:#92400e
    style Verify fill:#ecfdf5,stroke:#047857,color:#065f46
```
