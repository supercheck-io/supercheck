...
```mermaid
flowchart TD
    Services["<b>1. Add Services</b><br/>Define systems & telemetry names"] --> Links["<b>2. Link Checks</b><br/>Monitors, jobs, tests, status"]
    Links --> Connectors["<b>3. Add Connectors</b><br/>Read-only evidence sources"]
    Connectors --> Recipes["<b>4. Add Recipes</b><br/>Approved diagnostic queries"]
    Recipes --> Verify["<b>5. Test Investigation</b><br/>Run a test incident investigation"]
