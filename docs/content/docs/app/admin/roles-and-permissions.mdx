...
<Tabs items={['Organization', 'Project', 'Tests & Jobs', 'Monitors & Status Pages', 'Test Runs', 'CLI Tokens', 'Notifications', 'Tags']}>
...
<Callout type="warn">
**Project Editors** can create/edit variables (needed to use secrets in tests), but **cannot delete** variables or view secret values. This prevents accidental data loss and maintains security while allowing productive work.
</Callout>
