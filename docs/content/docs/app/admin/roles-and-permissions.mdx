...
```mermaid
flowchart LR
    SA["<b>Super Admin</b><br/>System-wide"] --> OO["<b>Org Owner</b><br/>Organization"]
    SA --> OA["<b>Org Admin</b><br/>Organization"]
    OO --> PA["<b>Project Admin</b><br/>Project"]
    OA --> PA
    PA --> PE["<b>Project Editor</b><br/>Project"]
    PE --> PV["<b>Project Viewer</b><br/>Read-only"]
