...
```mermaid
graph TD
    SA["<b>Super Admin</b><br/>System-wide Control"]
    OO["<b>Org Owner</b><br/>Organization Control"]
    OA["<b>Org Admin</b><br/>Organization Management"]
    PA["<b>Project Admin</b><br/>Assigned Projects"]
    PE["<b>Project Editor</b><br/>Assigned Projects"]
    PV["<b>Project Viewer</b><br/>Read-Only All Projects"]
    ...
    style SA fill:#ef4444,stroke:#b91c1c,color:#fff
    style OO fill:#f59e0b,stroke:#b45309,color:#fff
    style OA fill:#d97706,stroke:#92400e,color:#fff
    style PA fill:#8b5cf6,stroke:#6d28d9,color:#fff
    style PE fill:#3b82f6,stroke:#1e40af,color:#fff
    style PV fill:#64748b,stroke:#475569,color:#fff
```
