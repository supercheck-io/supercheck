...
- **Services** — Register production services and ownership metadata used to map alerts, incidents, and connector evidence.
...
See [AI SRE setup](/docs/app/admin/ai-sre-setup) for the full setup flow.
