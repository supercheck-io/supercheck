...
Automate user interactions with Playwright. Navigate pages, fill forms, click buttons, and validate content. Browser tests run in isolated containers with Chromium.
...
- Use `getSecret()` for passwords and API keys

## Learn More

- **[Supercheck Recorder Extension](/docs/recorder)** — Record user flows directly in Chrome/Edge and save as Playwright tests
