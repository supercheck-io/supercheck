...
| Metric | Description |
|--------|-------------|
| **Requirements** | Requirements tracked in your project |
...
| **Playwright Mins** | Playwright execution time over the last 30 days |
| **k6 VU x Mins** | k6 virtual-user minutes over the last 30 days |
...
![K6 Report Comparison](/screenshots/dashboard-k6-report-comparison.png)

### AI Analyze

Click **AI Analyze** to generate an AI-powered performance comparison report.

![AI Performance Analysis](/screenshots/dashboard-k6-ai-report-comparison.png)
