...
<Tabs items={['Quick Start', 'Production (HTTPS)', 'External Services']}>
  ...
  <Tab value="External Services">
    ...
    <Callout type="info">
    This compose file skips the bundled PostgreSQL, Redis, and MinIO containers. It starts the App, Worker, and Traefik containers; the Worker submits sandboxed jobs to the host K3s cluster configured earlier.
    </Callout>
  </Tab>
</Tabs>
