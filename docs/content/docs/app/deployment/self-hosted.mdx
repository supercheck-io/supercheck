...
flowchart LR
    ...
    subgraph EXEC["Execution — K3s + gVisor"]
        Worker["NestJS Worker (x N)<br/>Playwright · K6 · Monitors<br/>WORKER_LOCATION=local"]
        TestJobs["Sandboxed Test Jobs"]
        AgentWS["AI SRE Agent Workspace<br/>Per-investigation pod"]
    end
    ...
    style Worker fill:#10b981,stroke:#047857,color:#fff
    style TestJobs fill:#0d9488,stroke:#0f766e,color:#fff
    ...
    style EXEC fill:none,stroke:#94a3b8,stroke-dasharray: 4 4
