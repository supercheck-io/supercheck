---
title: Single-Location Deployment
...
<Accordions>
  <Accordion title="Registration Controls">
    ...
    ```bash
    # Disable new user registration (default: true)
...
| Configuration | `WORKER_REPLICAS` | `RUNNING_CAPACITY` (Concurrent Executions) | Minimum Server |
|---------------|-------------------|--------------------------------------------|----------------|
