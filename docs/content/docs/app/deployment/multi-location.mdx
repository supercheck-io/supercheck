...
3. Fill in the required fields:
   - **Code** — Unique identifier used in queue names (e.g. `us-east`). Must be lowercase, 2–63 characters, letters/digits/hyphens only, no consecutive hyphens. Reserved codes (`global`, `all`, `default`, `none`, `any`) are blocked.
...
<Steps>
  ...
  <Step>
    ...
    **2. Install gVisor (required):**
    ```bash
    curl -fsSL https://raw.githubusercontent.com/supercheck-io/supercheck/main/deploy/docker/setup-gvisor.sh | sudo bash
    ```
