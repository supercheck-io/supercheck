...
```mermaid
flowchart TB
    Incident[Incident investigation] --> Native[Native Supercheck evidence]
    Incident --> Direct[Direct connector]
    Incident --> Agent[Private Agent]
    Direct --> Provider[Provider API]
    Agent --> Provider
```
