...
rejected to protect the service from server-side request forgery.
...
- **Datadog:** API and application keys with read-only event access for the account's regional API site.
